...
describe("Shape", () => {
    ...
    describe("Circle", () => {
        it("Should create a red circle with purple text", () => {
            ...
            const expected = `<circle cx="100" cy="100" r="80" fill="Red" />
    <text x="35%" y="50%" text-anchor="middle" dy=".3em" fill="Purple" font-size="450%">AJS</text>`;
    ...
    describe("Square", () => {
        it("Should create a red square with blue text, given the hexidecimal value", () => {
            ...
            const expected = `<rect width="100" height="100" fill="#FF0000" />
